<script>
    $(document).ready(function() {
        ...
        $(document).on('click', '.btn_add_item', function() {
            ...
            frm.find('#temp_item').removeClass('d-none')
            frm.find('#temp_item').removeAttr('disabled','disabled')

            frm.find('#temp_item_name').addClass('d-none')
        })
        ...
        function modal_input_data(data = []) {
            ...
            frm.find('#temp_item').addClass('d-none')
            frm.find('#temp_item').attr('disabled','disabled')

            frm.find('#temp_item_name').removeClass('d-none')
            frm.find('#temp_item_name label').html(data.ITEM_NAME)

            frm.find('#item_min').val(data.STOCK_MIN)
            frm.find('#item_max').val(data.STOCK_MAX)
        }
