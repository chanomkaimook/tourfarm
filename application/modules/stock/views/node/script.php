<script>
    $(document).ready(function() {
        ...
        function resetForm() {
            ...
            // text modal from edit
            $(".temp-text-catagory").empty()
        ...
        function modal_input_data(data = []) {
            ...
            $(".temp-text-catagory").html(data.ITEM_CATAGORY_NAME)
        ...
        /* imgFile.onchange = evt => {
            ...
            if (file) {
                image_temp.innerHTML = '<img src="'+URL.createObjectURL(file)+'" height="300" >'
            }
        } */
