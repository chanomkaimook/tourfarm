...
class Mdl_node extends CI_Model

{
    ...
    public function get_data(int $id = null, array $optionnal = [])
    {
        $sql = $this->db->select(
            $this->table . '.ID as ITEM_ID,' .
                ...
                $this->table . '.NODE_CAT_ID as ITEM_CAT_ID,' .
                ...
                'node_catagory.ID as ITEM_CATAGORY_ID,' .
                'node_catagory.NAME_TH as ITEM_CATAGORY_NAME,'
        )
            ->join('node_catagory', 'node_catagory.id=' . $this->table . '.node_cat_id', 'left');
        if ($id) {
        ...
        $sql->where('node_catagory.status', 1);
    ...
    public function get_dataShowStore()
    {
        $result = $this->get_data(null, array($this->table . '.status_offview' => null,$this->table . '.node_cat_id' => 1));

        return $result;
    }

    public function get_dataShowSupplier()
    {
        $result = $this->get_data(null, array($this->table . '.status_offview' => null,$this->table . '.node_cat_id' => 2));
    ...
    public function update_data()
    {
        ...
        if ($item_catagory) {
            $data_array['node_cat_id'] = $item_catagory;
        }
